    ...
    return Scaffold(
        ...
        body: Center(
          child: Row(
            ...
            children: <Widget>[
              ElevatedButton(onPressed: onPressCall, child: const Text("Navigate to call example")),
              ElevatedButton(onPressed: onPressData, child: const Text("Navigate to data example"))
            ],
          ),
        ));
  }
