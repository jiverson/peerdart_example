  ...
  void initState() {
    ...
    peer.on<DataConnection>("connection").listen((event) {
      ...
      conn.on("binary").listen((data) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Got binary")));
      });
        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                  onPressed: sendHelloWorld, child: const Text("Send Hello World to peer")),
              ElevatedButton(onPressed: sendBinary, child: const Text("Send binary to peer")),
            ],
          ),
        ));
  }
